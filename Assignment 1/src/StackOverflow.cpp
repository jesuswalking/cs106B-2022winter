 ...
 *
 *     Nothing happens for couple of seconds, and my computer pops up a window that tells me "welcome to C++"
 *crashes due to some reasons. Guess the program runs out of the space.
 *
